...
### מהות המשחק:
המשחק היינו משחק חידות/הישרדות שבו שחקנים חוקרים תחנת חלל נטושה הנמצאת על סף תופעה קוסמית מסתורית הקרויה "הריק".
...
#### שחקנים:
- **קהל יעד:** המשחק מיועד לשחקנים בגילים 16 ומעלה, חובבי משחקי חידות, הישרדות ואסטרטגיה. מתאים לשחקנים מנוסים באווירת משחקי חידות, אך ניתן גם למתחילים.
- **מספר שחקנים:** שני שחקנים במצב שיתופי (CO-OP).
- **דפוסי אינטראקציה:** המשחק מעודד שיתוף פעולה, כאשר כל שחקן משחק דמות הכרחית להתקדמות המשחק.


#### יעדים:
### יעדי השחקן לניצחון במשחק:
- **הישרדות** השחקנים צריכים לשרוד באמצעות ניהול החמצן שלהם תוך כדי המשחק.
  - ניהול חיים וחמצן - מופיע על המסך כמה חמצן וחיים נשאר לשחקן, השחקן יכול להעלות את הכמות על ידי איסוף בלוני חמצן או תרופות המפוזרים במשחק.
...
- **הנחיות בתחילת המשחק** – המשחק יפתח את המשחק בהכוונה של מה צריך לעשות ומה המגבלות ואיך עליהם להתקדם.
...
2. **מתי ואיך:** מיד בתחילת המשחק, השחקן מקבל מבט קצר על הרס התחנה.
3. **פקדים:** מקלדת (WASD וחצים) לתזוזה.
4. **מה יקרה:** לאחר ההקדמה המשחק יפגיש בין שני השחקנים שמשחקים ביחד ויתחיל את המשחק עצמו.
...
1. **מי עושה מה ואיפה:** השחקנים מפעילים את מערכות התחנה בתזמון נכון תוך שיתוף פעולה ופתרון בעיות שעולות תוך כדי ניסיון להפעיל את מנגנון הבריחה.
    - השחקנים צריכים להפעיל 2 עמדות במקביל כאשר הם צריכים לתקשר ביניהם בשביל להפעיל הכל בצורה הנכונה ובזמן הנכון על מנת שהכל יעבוד בצורה טובה ויצליחו לסיים את המשחק.
...
#### חוקים:
- **חוקים מגבילים:** השחקנים מוגבלים במלאי משאבים, חייבים לשרוד תוך שמירה על מצב חמצן וחיים יציבים ונדרשים לפעול באופן אסטרטגי.
...
- **תוצאות פעולות:** כל פעולה תלווה בהשלכות על בריאותם הפיזית או מצב המשאבים שלהם אשר יכולים לגרור להפסד במשחק.
  - במידה והשחקן נמצא בחדר עם VOID יותר מידי זמן, מד החמצן שלו ירד והוא יצטרך להשיג חמצן כדי שמד החיים שלו לא יפגע, במידה והמד חיים מתחיל להיפגע הוא צריך לחפש תרופה בשביל להחזיר לעצמו חיים.
- **הדרכה על חוקים:** הסבר על החוקים מופיע בהתחלה וגם כחלק מהסיפור, דרך מסמכים ורשומות ויזואליות ברחבי התחנה.

#### משאבים:
- **משאבים זמינים:** חמצן, תרופות, וכלים לתיקון מערכות.
...
למי שמעדיף חשיבה תוך כדי ולא רק האקשן אז המשחק שלנו יותר יתאים לו.
